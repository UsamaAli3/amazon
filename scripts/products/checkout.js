...
Cart.forEach((cartItem) => {
  ...
  cartHtml += `
	<div class="cart-item-container js-cart-item-container-${cartProduct.id}">
	...
	<div class="cart-item-details-grid">
		...
		<div class="cart-item-details">
			...
			<div class="product-price">
				$${(cartProduct.priceCent / 100).toFixed(2)}
			</div>
			<div class="product-quantity">
				<span>
					Quantity: <span class="quantity-label">${cartProduct.quentity}</span>
				</span>
